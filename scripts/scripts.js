...
function door() {
    ...
    setTimeout(function(){ document.getElementById("map").src = "maps/lamproom.png"; }, 3000);
...
function randomcol(number){
    var coinaudio = new Audio('sounds/chest.wav');
    coinaudio.play()
...
function coinpickup(){
    ...
    var coinaudio = new Audio('sounds/coins.wav');
    coinaudio.play()
}
